    ...
    public SeedProduto(ModelBuilder builder)
    {
        List<Produto> produtos = new List<Produto>
        {
            ...
            new Produto
            {
                ...
                Descricao = "8 dadinhos de tapioca dourados e crocantes, acompanhados de geleia de pimenta artesanal. Petisco regional cheio de personalidade que vicia desde a primeira mordida.",
                QtdEstoque = 10,
                Preco = 19.95m,
            ...
            new Produto
            {
                ...
                Descricao = "Empada artesanal fresquinha com massa caseira e recheio generoso à escolha. Feita na hora com carinho e ingredientes de qualidade, sabor de quitanda barra-bonitense.",
                QtdEstoque = 10,
                Preco = 15.00m,
            ...
            new Produto
            {
                ...
                Descricao = "Pão de queijo regional assado na hora com recheio à escolha. Casquinha dourada, miolo macio e aquele gostinho de padaria artesanal que só a Vereda tem.",
                QtdEstoque = 20,
                Preco = 7.95m,
            ...
            new Produto
            {
                ...
                Descricao = "Torta artesanal com massa caseira e recheio generoso à escolha. Feita na hora com ingredientes frescos, carrega o sabor autêntico das quitandas de Barra Bonita.",
                QtdEstoque = 10,
                Preco = 11.95m,
